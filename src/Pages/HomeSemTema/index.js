...
const HomeAmizade = () => {
  ...
  const background = '/assets/semtema.png'; // Defina o fundo da página atual
  ...
  return (
    <Container style={{ backgroundImage: `url(${background})` }}>
      ...
      <Menu>
        <FPR src="/assets/FPRColorido.png" alt="Logo FPR" />
        ...
        <Busca onDigimonFetch={handleDigimonFetch} />
      </Menu>
